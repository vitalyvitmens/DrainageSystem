class PricePlank {
  /*
  Класс PricePlank (Прайс Доборка), он принимает 
  на вход следующие свойства (параметры):
  - double plank_price_mat (стоимость матовой доборки за 1м2 в руб)
  - double plank_price_050 (стоимость глянцевой 0.50мм доборки за 1м2 в руб)
